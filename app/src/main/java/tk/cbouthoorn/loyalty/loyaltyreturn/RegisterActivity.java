...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptRegister() {
        ...
        if (!TextUtils.isEmpty(password) && ! CredentialChecker.isValidPassword(password)) {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            cancel = true;
        } else if (! CredentialChecker.isValidUsername(email)) {
        ...
        if (cancel) {
            ...
            new UserRegisterTask(this, email, password).execute();
        }
    }
